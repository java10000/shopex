...
</script> <form action="index.php?ctl=goods/product&act=toAdd" method="post" name="gEditor" id="gEditor"> <input type="hidden" name="goods[goods_id]" value="<?php echo $this->_vars['goods']['goods_id']; ?>" id="gEditor-GId-input"/> <input type="hidden" name="goods[old_marketable]" value="<?php echo $this->_vars['goods']['marketable']; ?>"/> <div id="gEditor-Body"> <?php $_tpl_tpl_vars = $this->_vars; echo $this->_fetch_compile_include("product/detail/page.html", array()); $this->_vars = $_tpl_tpl_vars; unset($_tpl_tpl_vars); ?> </div> </form> <script>


var goodsEditor = new ShopExGoodsEditor('gEditor',{imgtype:'<?php echo $this->_vars['uploader']; ?>',url:'<?php echo $this->_vars['url']; ?>',goods_id:'<?php echo $this->_vars['goods']['id']; ?>'});
